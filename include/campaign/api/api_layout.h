...
extern "C"
{
    ...
    CAMPAIGN_API void campaign_layout_push_flag(void *layoutPtr, const char* id);

    CAMPAIGN_API void campaign_layout_push_flag_empty(void *layoutPtr);

    CAMPAIGN_API void campaign_layout_push_byte(void *layoutPtr, const char* id);

    CAMPAIGN_API void campaign_layout_push_byte_empty(void *layoutPtr);

    CAMPAIGN_API void campaign_layout_push_dynamic(void *layoutPtr, const char* id, int32_t size);

    CAMPAIGN_API void campaign_layout_push_dynamic_empty(void *layoutPtr, int32_t size);

    CAMPAIGN_API bool campaign_layout_entry_exists(void *layoutPtr, const char* id);
    ...
    CAMPAIGN_API campaign_descriptor_t campaign_layout_get_descriptor(void *layoutPtr, const char* id);

    CAMPAIGN_API campaign_flag_info_t campaign_layout_get_flag_info(void *layoutPtr, const char* id);

    CAMPAIGN_API campaign_byte_info_t campaign_layout_get_byte_info(void *layoutPtr, const char* id);

    CAMPAIGN_API campaign_dynamic_info_t campaign_layout_get_dynamic_info(void *layoutPtr, const char* id, int32_t expectedSize);
#ifdef __cplusplus
}
#endif