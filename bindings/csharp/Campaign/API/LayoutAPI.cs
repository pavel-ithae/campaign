...
internal static partial class LayoutAPI
{
    ...
    [LibraryImport(APIUtility.LIBRARY_NAME, StringMarshalling = StringMarshalling.Utf8, EntryPoint = "campaign_layout_entry_count")]
    internal static partial APIResult GetEntryCount(IntPtr layoutPtr, out int entryCount);

    [LibraryImport(APIUtility.LIBRARY_NAME, StringMarshalling = StringMarshalling.Utf8, EntryPoint = "campaign_layout_data_size")]
